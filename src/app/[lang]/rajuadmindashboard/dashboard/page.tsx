...
export default function DashboardPage() {
    ...
    const quickActions = [
        { label: t('dashboard_add_emoji'), href: `/${params.lang}/rajuadmindashboard/emojis`, icon: PlusCircle },
        { label: t('dashboard_add_page'), href: `/${params.lang}/rajuadmindashboard/pages`, icon: FilePlus },
        { label: t('dashboard_manage_categories'), href: `/${params.lang}/rajuadmindashboard/categories`, icon: ArrowRight },
    ];
