...
export function AdminSidebar() {
  ...
  const menuItems = [
    {
      href: `/rajurajadmin/dashboard`,
      label: t('admin_dashboard'),
      icon: LayoutDashboard,
      activeMatch: '/rajurajadmin/dashboard',
    },
    {
      href: `/rajurajadmin/emojis`,
    ...
    },
    {
      ...
      label: t('admin_pages'),
      icon: FileText,
      activeMatch: '/rajurajadmin/pages',
    },
    {
      href: `/rajurajadmin/media`,
      label: t('admin_media'),
      icon: Library,
    ...
    },
    {
      ...
      icon: Megaphone,
      activeMatch: '/rajurajadmin/ads-settings',
    },
    {
      href: `/rajurajadmin/footer-settings`,
      label: t('admin_footer_settings'),
      icon: FileText,
      activeMatch: '/rajurajadmin/footer-settings',
    },
     {
      href: `/rajurajadmin/ads-txt`,
      label: "Ads.txt",
      icon: FileText,
      activeMatch: '/rajurajadmin/ads-txt',
    },
     {
      href: `/rajurajadmin/colors`,
      label: 'Colors',
      icon: Palette,
      activeMatch: '/rajurajadmin/colors',
    },
    {
      href: `/rajurajadmin/settings`,
      label: t('admin_settings'),
      icon: Settings,
      activeMatch: '/rajurajadmin/settings',
    },
  ];
